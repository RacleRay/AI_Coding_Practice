...
class Model(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        custom_params = list(self.layer_norm.named_parameters()) + \
                        list(self.pooler.named_parameters()) + \
                        list(self.regressor.named_parameters())
        ...
        optimizer_grouped_parameters = [
            {'params': [p for n, p in bert_params if not any(nd in n for nd in no_decay) and not any(nd in n for nd in group_all)],'weight_decay': CONFIG.weight_decay},
            ...
            {'params': [p for n, p in bert_params if any(nd in n for nd in no_decay) and not any(nd in n for nd in group_all)],'weight_decay': 0.0},
            ...
            # difference
            {'params': [p for n, p in custom_params if not any(nd in n for nd in no_decay)], 'lr': CONFIG.learning_rate * 100, "weight_decay": CONFIG.weight_decay},
            {'params': [p for n, p in custom_params if any(nd in n for nd in no_decay)], 'lr': CONFIG.learning_rate * 100, "weight_decay": 0.0},
        ]
        optimizer = AdamW(
            optimizer_grouped_parameters,
